...
// Query: *[_type == "startup" && _id == $id][0] {  _id,  title,  views,  slug,  _createdAt,  category,  description,  image,  pitch,  author -> {    _id , name , username, image , bio  }}
...
// Query: *[_type == "author" && githubId == $id][0] {  _id,  id,  githubId,  name,  username,  email,  image,  bio,  startup -> {    _id,    title,    slug  }}
